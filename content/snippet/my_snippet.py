[
    ...
    { trigger: "Ex", replacement: "\\ex[${0:X}] $1", options: "mA" },
        ...
        { trigger: "n\\orm", replacement: "\\norm[${0:P}] $1", options: "mA" , priority: 100,},
    ...
    // Automatically convert text of the form "x=2" and "x=n+1" to math.
    {
      ...
      { trigger: "lri", replacement: "\\underline{\\int^{${0:b}}_{${1:a}}}${2:f} $3", options: "mA" },
  { trigger: "uri", replacement: "\\overline{\\int^{${0:b}}_{${1:a}}}${2:f} $3", options: "mA" },
